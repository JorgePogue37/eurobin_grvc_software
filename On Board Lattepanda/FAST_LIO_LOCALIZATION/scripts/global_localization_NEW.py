...
def kill_node(node_name):
    try:
        # Call 'rosnode kill' to kill the specific node
        subprocess.check_call(['rosnode', 'kill', node_name])
        rospy.loginfo("Node {} killed successfully.".format(node_name))
    except subprocess.CalledProcessError as e:
        rospy.logerr("Failed to kill node {}: {}".format(node_name, e))
